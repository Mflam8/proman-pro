...
export default function WhatsAppMascot({ phoneNumber = "50360531213", message, mascotUrl, bubbleText, hideBubble }) {
  ...
  return (
    <div className="fixed right-4 top-[58vh] -translate-y-1/2 z-50 flex items-end gap-3 sm:right-6 sm:top-[62vh]">
      ...
      <a href={href} target="_blank" rel="noopener noreferrer" aria-label="Contactar por WhatsApp" className="relative inline-block">
        {/* Ping suave */}
        <span className="absolute -inset-2 rounded-full bg-green-500/25 animate-ping" aria-hidden />
        {mascotUrl ? (
          <img
            src={mascotUrl}
            alt="WhatsApp PROMAN"
